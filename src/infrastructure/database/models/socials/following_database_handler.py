...
class FollowingDatabaseHandler:
    ...
    async def get_following_by_user_id(
        ...
        following = (following_collection.find_one({'_id': ObjectId(user_id)}, {'following': 1}))
    ...
    @staticmethod
    async def delete_user_from_following(collection: Collection[Following], user_id: str,
    ...
    @staticmethod
    async def check_if_user_in_following(collection: Collection[Following], user_id: str,
