INSERT INTO alcohol
VALUES (DEFAULT, 'Żywiec białe', 'european wheat lager',
        ...
        4.9, 5.0, 'Polska', NULL, NULL, NULL, 18, 'witbier', 2.4, 10.2, '4-6', 11.6, 'Żywiec', 'beer', NULL,
        'kolendra'),
       (DEFAULT, 'Soplica Szlachetna Wódka', 'czysta',
        ...
        40.0, 4.3, 'Polska', NULL, 'przezroczysty', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'Soplica', 'vodka', NULL,
        'mieszanka zbóż');
