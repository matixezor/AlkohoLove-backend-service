INSERT INTO alcohol
VALUES (DEFAULT, 'Żywiec białe', 'beer', 5.0, 'european wheat lager',
        ...
        1, 4.9, NULL, NULL, 18, 2.4, 11.6, '4-6', 'Żywiec', NULL, NULL),
       (DEFAULT, 'Soplica Szlachetna Wódka', 'vodka', 4.0, 'czysta',
        ...
        1,
        40.0, 'przezroczysty', NULL, NULL, NULL, NULL, NULL, 'Soplica', NULL, NULL);
